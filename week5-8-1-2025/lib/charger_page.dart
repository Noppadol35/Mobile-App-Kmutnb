import 'package:ev_charge_car/info_page.dart';
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => InfoPage(
                        soc: double.parse(soc.text),
                        tarSoc: double.parse(tarSoc.text),
                        chargeRate: double.parse(chargeRate.text),
                        voltage: double.parse(voltage.text),
                        cap: double.parse(cap.text),
                        eiffic: double.parse(eiffic.text),
                      ),
                    ),
                  );
                  setState(() {
